		  ...
		  try
		  {
			...
			switch(choice)
			{
					...
					switch(option1)
					{
						...
						default:
							...
							break;
                                        ...
                                        System.out.println("press 5 for going back to main menu");
                                        
                                        System.out.println("press 6 for going back to Employee Management menu");
                                        o = sc.nextInt();
				...
				case 2:
                    ...
                    catch(IOException io)
					{
						System.out.println("Something went wrong.");
                                        ...
                                        System.out.println("press 6 for going back to Shop Management menu");
                                        o = sc.nextInt();
                        }
                                    while(o==6);
						...
						catch(NullPointerException np)
					   {
						...
						default:
							...
							break;
                                        ...
                                        System.out.println("press 6 for going back to Shop Product Management menu");
                                        o = sc.nextInt();
                                    }
                                    while(o==6);
                ...
                case 4:
					...
					//NullPointer Exception
					catch(NullPointerException | FileNotFoundException np)
					{
						System.out.println(np.getMessage());
					}
					//IO Exception
                    catch(IOException io)
					{
						System.out.println("Something went wrong.");
                                        ...
                                        System.out.println("press 5 for going back to Product Quantity Add-Sell menu");
                                        o = sc.nextInt();
                    }
                    while(o==5);
                    System.out.println("--------------------------------");
